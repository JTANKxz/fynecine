...
class TvChannelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // EPG timestamps are stored in UTC; keep the database comparison in UTC.
        $now = now('UTC');
    ...
    public function show($idOrSlug)
    {
        ...
        return response()->json([
            ...
            'schedule' => \App\Models\EpgProgram::where('tv_channel_id', $channel->id)->where('ends_at', '>', now('UTC')->subHour())->orderBy('starts_at')->limit(24)->get(),
        ]);
    }
