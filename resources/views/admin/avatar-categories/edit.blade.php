...
@section('title', 'Editar Categoria de Avatar')

@section('content')
<section class="max-w-2xl">
    <div class="mb-6">
        <h2 class="text-2xl font-bold">Editar Categoria de Avatar</h2>
        <p class="text-neutral-400 text-sm">Altere o nome da categoria para organizar seus avatares.</p>
    </div>
    ...
    <div class="bg-neutral-900 p-6 rounded-xl border border-neutral-800">
        <form action="{{ route('admin.avatar-categories.update', $category->id) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            <div>
