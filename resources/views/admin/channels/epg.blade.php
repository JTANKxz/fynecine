...
<section class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-xl font-bold">Programação dos Canais (EPG)</h2>
    ...
    <div class="rounded-xl border border-neutral-800 bg-neutral-900 p-5">
        ...
        <div class="mt-4 rounded-lg border border-neutral-800 bg-neutral-950/50 p-3 text-xs text-neutral-400">
            ...
            <p class="mt-2">Trocar de fonte remove os vínculos anteriores para evitar que um canal fique associado a um identificador antigo.</p>
        </div>
