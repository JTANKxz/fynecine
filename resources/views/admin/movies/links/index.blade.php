...
@section('content')
    <section>
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold">Links Cadastrados</h2>

            <div class="flex items-center gap-2">
                <a href="{{ route('admin.movies.links.create', $movie->id) }}"
                        ...
                        @forelse ($links as $link)
                            <tr class="border-b border-neutral-800 hover:bg-neutral-800/50">
                                ...
                                <td class="p-4 flex items-center gap-3">
                                    ...
                                    {{-- editar --}}
                                    <a href="{{ route('admin.movies.links.edit', $link->id) }}"
                                        class="text-blue-500 hover:text-blue-400">
                                        <i class="fa-solid fa-edit"></i>
                                    </a>

                                    {{-- deletar --}}
                                    <form action="{{ route('admin.movies.links.delete', $link->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
