        ...
        <form action="{{ route('admin.series.update', $serie->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2 space-y-2">
                    ...
                    <div class="relative">
                        <input type="text" value="{{ $serie->tmdb_id }}" readonly aria-readonly="true"
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <input type="text" name="logo_path" value="{{ old('logo_path', $serie->logo_path) }}"
                           class="w-full px-4 py-2 bg-neutral-800 text-white rounded-lg border border-neutral-700 focus:border-netflix focus:outline-none transition">
                ...
                @include('admin.tmdb.partials.image-picker', ['type' => 'tv', 'tmdbId' => $serie->tmdb_id])
